...
(3, 'Sprite', 'Refreshing classic sprite soda', 100, '3.00'),
(4, 'Latte', 'Steamed milk with shot of espresso', 100, '7.00'),
(5, 'Banana Milkshake', 'A thick and creamy shake with the perfect ratio of banana fruit to ice cream to milk packed full of banana flavor', 100, '7.00'),
(6, 'Mocha', 'Latte and premium cocoa powder with whipped cream drizzled with chocolate syrups', 100, '7.00'),
(7, 'Belgian Waffle with Nutella and Strawberry', 'Belgian waffle serve with nutella and fresh strawberry', 100, '12.00'),
...
(57, 'Fruit Salad', 'A salad dish consisting of various kinds of fruit', 100, '9.00'),
